...
import { FolderKanban, Images, LayoutDashboard, MessageSquareQuote, Settings, Type, Users } from "lucide-react";
...
export function AdminSidebar({
  ...
  return (
    <aside
      className={cn(
        "sticky top-0 h-screen self-start overflow-hidden border-r border-gray-200 bg-white px-3 py-4 dark:border-gray-800 dark:bg-gray-950",
        className
      )}
    >
