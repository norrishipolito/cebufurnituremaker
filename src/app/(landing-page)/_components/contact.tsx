...
export function Contact() {
  return (
    <section id="contact" className="flex min-h-screen w-full items-center justify-center py-12 px-4 sm:py-16 sm:px-6 md:py-20 lg:py-24 lg:px-8 bg-white dark:bg-gray-950">
